...
require('./node_modules/promise/polyfill.js.js');
    ...
    var parse = function (input, options, callback) {
        ...
        if (!callback) {
            if (!PromiseConstructor) {
                PromiseConstructor = typeof Promise === 'undefined' ? require('./node_modules/promise') : Promise;
            }
            var self = this;
...
var asap = require('./node_modules/asap')
